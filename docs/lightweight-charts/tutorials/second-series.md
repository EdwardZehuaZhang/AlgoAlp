# Tutorial: Second Series

*Source: tutorials\customization\second-series.html*
...
It is recommend that you follow the guide from the [start](intro.md). However, if you are only interested in the content on this page then take a look at the [full code](second-series.html#complete-code) at the bottom of page for context of how this code fits into a working example.

In this section, we will be adding an [area series](../../docs/series-types.html#area) to the chart with a subtle vertical gradient. It's purpose is solely for aesthetic reasons (only to make the chart more visually appealing). However, it will teach us a few key points about the differences between different series types and the visual stacking order.

## Preparing the data for the area series[​](second-series.html#preparing-the-data-for-the-area-series "Direct link to Preparing the data for the area series")
...
## Adding the area series and setting it's options[​](second-series.html#adding-the-area-series-and-setting-its-options "Direct link to Adding the area series and setting it's options")
...
## Visual stacking order of series[​](second-series.html#visual-stacking-order-of-series "Direct link to Visual stacking order of series")
...
## Result[​](second-series.html#result "Direct link to Result")

At this point we should have a chart like this:

[View in a new window](../../4ce3dd9dcf7c5ea67e4c322bbbe543e5.md)

## Next steps[​](second-series.html#next-steps "Direct link to Next steps")

In the next step, we will look at how to adjust the colour of individual candlesticks on our chart.

## Download[​](second-series.html#download "Direct link to Download")

You can download the HTML file for example at this stage [here](../../4ce3dd9dcf7c5ea67e4c322bbbe543e5.md) in case you've encountered a problem or would like to start the next step from this point.

## Complete code[​](second-series.html#complete-code "Direct link to Complete code")
